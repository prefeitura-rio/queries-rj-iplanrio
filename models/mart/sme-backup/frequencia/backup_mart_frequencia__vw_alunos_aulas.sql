...
with alunos_aulas as (
    ...
    from {{ ref('_raw_gestao_escolar__turma_aula_aluno') }} as taa
    inner join {{ ref('_raw_gestao_escolar__turma_aula') }} as tau
    ...
    inner join {{ ref('_raw_gestao_escolar__mtr_matricula_turma') }} as mtu
    ...
    inner join {{ ref('_raw_gestao_escolar__tur_turma') }} as tur
        on mtu.tur_id = tur.tur_id
    inner join {{ ref('_raw_gestao_escolar__formato_avaliacao') }} as fav
    ...
    left join {{ ref('_raw_gestao_escolar__aluno_justificativa_falta') }} as afj
    ...
    left join {{ ref('_raw_gestao_escolar__tipo_justificativa_falta') }} as tjf
