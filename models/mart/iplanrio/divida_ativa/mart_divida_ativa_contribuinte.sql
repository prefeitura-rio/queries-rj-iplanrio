...
select a.id_pessoa, 
    ...
    b.cdas_associadas,
    c.quantidade_guias,
    d.valor_cotas_devidas_a_vencer,
    d.quantidade_cotas_devidas_a_vencer,
    d.valor_cotas_devidas_vencidas,
    d.quantidade_cotas_devidas_vencidas,
    d.valor_cotas_pagas,
    d.quantidade_cotas_pagas,
    c.guias_pagamento
