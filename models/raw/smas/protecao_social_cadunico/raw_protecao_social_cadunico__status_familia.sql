...
SELECT
    ...
    --column: dt_oaud_irregularidade_fam
    NULL AS data_oaud_irregularidade_fam, --Essa coluna não esta na versao posterior
    ...
    --column: dt_paud_irregularidade_fam
    NULL AS data_paud_irregularidade_fam, --Essa coluna não esta na versao posterior
    ...
    --column: ind_oaud_irregularidade_fam
    NULL AS id_oaud_irregularidade_fam, --Essa coluna não esta na versao posterior
    --column: ind_oaud_irregularidade_fam
    NULL AS oaud_irregularidade_fam, --Essa coluna não esta na versao posterior
    ...
    --column: ind_paud_irregularidade_fam
    NULL AS id_paud_irregularidade_fam, --Essa coluna não esta na versao posterior
    --column: ind_paud_irregularidade_fam
    NULL AS paud_irregularidade_fam, --Essa coluna não esta na versao posterior
...
SELECT
    ...
    SAFE.PARSE_DATE(
        '%d%m%Y',
        CASE
            WHEN REGEXP_CONTAINS(SUBSTRING(text,123,8), r'^\s*$') THEN NULL
            ELSE TRIM(SUBSTRING(text,123,8))
        END    ) AS data_oaud_irregularidade_fam,
    ...
    SAFE.PARSE_DATE(
        '%d%m%Y',
        CASE
            WHEN REGEXP_CONTAINS(SUBSTRING(text,132,8), r'^\s*$') THEN NULL
            ELSE TRIM(SUBSTRING(text,132,8))
        END    ) AS data_paud_irregularidade_fam,
    ...
    CAST(
        CASE
            WHEN REGEXP_CONTAINS(SUBSTRING(text,122,1), r'^\s*$') THEN NULL
            ELSE TRIM(SUBSTRING(text,122,1))
        END AS STRING
    ) AS id_oaud_irregularidade_fam,
    --column: ind_oaud_irregularidade_fam
    CAST(
        CASE
            WHEN REGEXP_CONTAINS(SUBSTRING(text,122,1), r'^\s*$') THEN NULL
            WHEN REGEXP_CONTAINS(SUBSTRING(text,122,1), r'^0$') THEN 'Não Existe'
            WHEN REGEXP_CONTAINS(SUBSTRING(text,122,1), r'^1$') THEN 'Existe'
            ELSE TRIM(SUBSTRING(text,122,1))
        END AS STRING
    ) AS oaud_irregularidade_fam,
    ...
    CAST(
        CASE
            WHEN REGEXP_CONTAINS(SUBSTRING(text,131,1), r'^\s*$') THEN NULL
            ELSE TRIM(SUBSTRING(text,131,1))
        END AS STRING
    ) AS id_paud_irregularidade_fam,
    --column: ind_paud_irregularidade_fam
    CAST(
        CASE
            WHEN REGEXP_CONTAINS(SUBSTRING(text,131,1), r'^\s*$') THEN NULL
            WHEN REGEXP_CONTAINS(SUBSTRING(text,131,1), r'^0$') THEN 'Não Existe'
            WHEN REGEXP_CONTAINS(SUBSTRING(text,131,1), r'^1$') THEN 'Existe'
            ELSE TRIM(SUBSTRING(text,131,1))
        END AS STRING
    ) AS paud_irregularidade_fam,
...
SELECT
    ...
    SAFE_CAST(data_particao AS DATE) AS data_particao
FROM `rj-iplanrio.brutos_cadunico_staging.registro_familia`
WHERE versao_layout_particao = '0628'
    AND SUBSTRING(text,38,2) = '13'
