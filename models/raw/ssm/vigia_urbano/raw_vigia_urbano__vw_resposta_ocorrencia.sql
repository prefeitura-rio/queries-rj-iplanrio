...
SELECT
    ...
    safe_cast(TRIM(coordenadaX) AS string) AS coordenada_x,
    safe_cast(TRIM(coordenadaY) AS string) AS coordenada_y,
    safe_cast(TRIM(coordenadaXDispositivo) AS string) AS coordenada_x_dispositivo,
    safe_cast(TRIM(coordenadaYDispositivo) AS string) AS coordenada_y_dispositivo,
