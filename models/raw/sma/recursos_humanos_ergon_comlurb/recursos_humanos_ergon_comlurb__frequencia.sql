{{
    config( alias='frequencia',schema='recursos_humanos_ergon_comlurb')
}}
...
SELECT
    ...
    SAFE_CAST(TRIM(hora_entrada) AS STRING) AS hora_entrada,
    SAFE_CAST(TRIM(hora_saida) AS STRING) AS hora_saida,
