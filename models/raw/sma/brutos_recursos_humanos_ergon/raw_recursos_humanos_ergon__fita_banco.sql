...
SELECT
    ...
    SAFE_CAST(REGEXP_REPLACE(numero, r'\.0$', '') AS string) AS numero_folha,
    SAFE_CAST(rubrica AS string) AS id_rubrica,
    ...
    SAFE_CAST(REGEXP_REPLACE(numpens, r'\.0$', '') AS string) AS id_pensionista,
    SAFE_CAST(REGEXP_REPLACE(numdepen, r'\.0$', '') AS string) AS id_dependente,
