...
SELECT
    ...
    parse_date('%d/%m/%Y', FLEX_CAMPO_70)  AS data_primeiro_emprego,
    ...
    PARSE_DATE('%d/%m/%Y', FLEX_CAMPO_27) AS data_expedicao_cnh,
    ...
    parse_date('%d/%m/%Y', FLEX_CAMPO_08) AS data_emissao_ric,
    PARSE_DATE('%d/%m/%Y', FLEX_CAMPO_28) AS expedicao_documento_orgao_classe,
    ...
    parse_date('%d/%m/%Y', FLEX_CAMPO_36) AS data_ultima_atualizacao_bancaria,
    ...
    parse_date('%d/%m/%Y', FLEX_CAMPO_60)  AS data_alteracao_sexo,
    ...
    parse_date('%d/%m/%Y', FLEX_CAMPO_11)  AS data_expedicao_rne,
    parse_date('%d/%m/%Y', FLEX_CAMPO_12)  AS data_chegada_estrangeiro,
    parse_date('%d/%m/%Y', FLEX_CAMPO_13)  AS data_naturalizacao,
