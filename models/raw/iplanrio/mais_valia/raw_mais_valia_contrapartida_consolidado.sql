...
calculos_contrapartida as (
        select 
            ...
            safe_cast(inscricao_iptu as string) as inscricao_iptu,
            safe_cast(documentacao_ok as boolean) as documentacao_ok,
            safe_cast(darm_inicial_ok as boolean) as darm_inicial_ok,
            ...
            safe_cast(estado_laudo as string) as estado_laudo,
