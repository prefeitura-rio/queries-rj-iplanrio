...
select
  ...
  safe_cast(num_sequencial_parte as int64)            as id_sequencial_parte,
  ...
  safe_cast(qualificacao_da_parte as string)          as qualificacao,
  ...
  safe_cast(mat_responsavel as int64)                as matricula_responsavel
