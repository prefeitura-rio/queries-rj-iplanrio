...
SELECT safe_cast(idProtesto as int64) as id_protesto,
    ...
    safe_cast(dataProtocolo as datetime) as data_protocolo,
    ...
    safe_cast(dataOcorrencia as datetime) as data_ocorrencia,
    safe_cast(dataEmissaoTitulo as datetime) as data_emissao_cda,
    safe_cast(dataVencimentoTitulo as datetime) as data_vencimento_guia,
    ...
    safe_cast(datInclusao as datetime) as data_inclusao,
