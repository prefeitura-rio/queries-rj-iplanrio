...
SELECT safe_cast(idProtesto as int64) as id_protesto,
    ...
    safe_cast(left(dataProtocolo, 10) as date) as data_protocolo,
    ...
    safe_cast(left(dataOcorrencia, 10) as date) as data_ocorrencia,
    safe_cast(left(dataEmissaoTitulo, 10) as date) as data_emissao_cda,
    safe_cast(left(dataVencimentoTitulo, 10) as date) as data_vencimento_guia,
    ...
    safe_cast(left(datInclusao, 10) as date) as data_inclusao,
