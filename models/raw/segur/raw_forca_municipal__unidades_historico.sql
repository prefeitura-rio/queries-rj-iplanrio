...
SELECT
    ...
    SAFE_CAST(REPLACE(DispatchAlarmLevel, ".0", "") AS INT64) AS nivel_alarme_despacho, -- NULO
    ...
    SAFE_CAST(Status AS STRING) AS status_final, -- NULO
    SAFE_CAST(StatusedAgencyEventId AS STRING) AS id_ocorrencia,
    SAFE_CAST(REPLACE(StatusedAgencyEventRevisionNum, ".0", "") AS INT64) AS numero_revisao_ocorrencia,
    SAFE_CAST(REPLACE(StatusedAgencyEventSubtypeCode, ".0", "") AS STRING) AS codigo_subtipo_ocorrencia,
    SAFE_CAST(StatusedAgencyEventTypeCode AS STRING) AS codigo_tipo_ocorrencia,
    SAFE_CAST(REPLACE(TotalAvailableStationTime, ".0", "") AS STRING) AS tempo_total_disponivel_base,
    SAFE_CAST(REPLACE(TotalEventCount, ".0", "") AS INT64) AS contagem_total_ocorrencias,
    SAFE_CAST(REPLACE(TotalEventTime, ".0", "") AS INT64) AS tempo_total_ocorrencias,
    SAFE_CAST(REPLACE(TotalUnavailableTime, ".0", "") AS INT64) AS tempo_total_indisponivel,
