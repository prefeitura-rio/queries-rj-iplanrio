...
SELECT
    ...
    SAFE_CAST(REPLACE(DispatchAlarmLevel, ".0", "") AS INT64) AS nivel_alarme_despacho,
    ...
    SAFE_CAST(Status AS INT64) AS codigo_status_atual, -- NULO
    ...
    SAFE_CAST(StatusedAgencyEventSubtypeCode AS STRING) AS codigo_subtipo_ocorrencia, -- NULO
